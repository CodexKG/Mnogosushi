...
from apps.tables.views import menu, menu_detail, add_to_order, table_clear_cart, table_remove_from_cart, table_update_cart_item  , order, category_menu_detail


urlpatterns = [
    path('<int:table_uuid>/', menu, name='menu'),
    path('product/<int:product_id>/<int:table_uuid>/', menu_detail, name="menu_detail"),
